/*:
 * @target MZ
 * @plugindesc 고급 UI 렌더링, 수학 연산 및 인터랙티브 애니메이션 구성을 위한 코어 확장 시스템 플러그인입니다.
 * @author limpid
 *
 * @help
 * ============================================================================
 * 플러그인 개요
 * ============================================================================
 * 이 플러그인은 RPG Maker MZ의 코어 스크립트(Array, Bitmap, Math, Sprite 등)를 
 * 확장하여 고성능 UI 제작과 고급 수학적 처리를 지원합니다.
 * * 복잡한 렌더링 로직, 기하학 연산, 애니메이션 흐름 제어를 위한 독자적인 클래스
 * (Weaver, Cotton, Adorn, Handler, Runflow, Rhythm)를 포함하고 있습니다.
 *
 * ============================================================================
 * 주요 기능 및 특징
 * ============================================================================
 * - Bitmap 확장: 곡선, 원형, 다각형, 둥근 모서리 등 고급 기하학 도형 렌더링.
 * - Math 확장: 베지어 곡선, 다각형 변환, 충돌 검사 및 고급 확률/통계 연산.
 * - Array & String 확장: 데이터 조작을 위한 유틸리티 메서드 (조합, 셔플 등).
 * - UI 코어 시스템:
 * - Weaver & Cotton: 복합적인 UI 요소의 생성 및 계층 관리.
 * - Adorn & Handler: 화면 내 객체의 상태 전이 및 터치/키보드 이벤트 정밀 제어.
 * - Rhythm & Runflow: 복잡한 수학적 주기(Sin, Tri, Squ 등)를 활용한 애니메이션 제어.
 *
 * ============================================================================
 * 사용 시 주의사항
 * ============================================================================
 * 코어 클래스의 프로토타입을 다수 덮어쓰고 확장하므로, 플러그인 관리자에서 
 * 가능한 최상단(Core 플러그인 바로 아래)에 배치하는 것을 권장합니다.
 */
